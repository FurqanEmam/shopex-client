      ...
      <footer className="flex flex-col text-black">
        <div className="flex justify-around items-center bg-sky-50 py-10">
          <aside className="text-xl">
            ...
            <p className="font-jura font-bold text-2xl">ShopeX</p>
          </aside>
          <nav className="flex flex-col gap-3 text-lg">
            <ul className="font-jura font-semibold ">
              <li>
                <a className="cursor-pointer hover:underline">Facebook</a>
              </li>
              <li>
                <a className="cursor-pointer hover:underline">YouTube</a>
              </li>
              <li>
        ...
        <aside className="bg-sky-100 py-5 font-bold font-jura text-center text-sm">
